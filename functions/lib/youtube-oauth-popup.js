...
exports.checkYouTubeStatus = exports.fetchYouTubeVideos = exports.exchangeYouTubeCode = exports.initializeYouTubeOAuth = void 0;
 ...
 */
exports.initializeYouTubeOAuth = (0, https_1.onRequest)({
    cors: true,
    region: 'us-central1',
 ...
 */
exports.exchangeYouTubeCode = (0, https_1.onRequest)({
    cors: true,
    region: 'us-central1',
}, async (request, response) => {
    var _a, _b;
    ...
    try {
        ...
        const channel = (_a = channelData.items) === null || _a === void 0 ? void 0 : _a[0];
        if (!channel) {
        ...
        await db.collection('users').doc(userId).update({
            ...
            youtubeProfile: {
                ...
                subscriberCount: formattedSubs,
                bannerImageUrl: ((_b = channel.snippet.thumbnails.high) === null || _b === void 0 ? void 0 : _b.url) || '',
                lastSynced: new Date(),
            },
        });
 ...
 */
exports.fetchYouTubeVideos = (0, https_1.onRequest)({
    cors: true,
    region: 'us-central1',
}, async (request, response) => {
    var _a, _b, _c, _d;
    ...
    try {
        ...
        const maxResults = Math.min(parseInt(request.query.maxResults) || 50, 50);
        ...
        const channelData = await channelResponse.json();
        const uploadsPlaylistId = (_d = (_c = (_b = (_a = channelData.items) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.contentDetails) === null || _c === void 0 ? void 0 : _c.relatedPlaylists) === null || _d === void 0 ? void 0 : _d.uploads;
        ...
        const videos = videosData.items.map((video) => {
            ...
            return ({
                ...
                thumbnailHigh: (_a = video.snippet.thumbnails.high) === null || _a === void 0 ? void 0 : _a.url,
 ...
 */
exports.checkYouTubeStatus = (0, https_1.onRequest)({
    cors: true,
    region: 'us-central1',
}, async (request, response) => {
    var _a;
    ...
    try {
        ...
        response.json({
            ...
            lastSynced: (_a = data.updatedAt) === null || _a === void 0 ? void 0 : _a.toDate().toISOString(),
        });
    }
    catch (error) {
...
//# sourceMappingURL=youtube-oauth-popup.js.map