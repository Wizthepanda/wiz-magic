/**
 * ZAP Wallet V8 — "ZAP Friends" Referral Integration
 * Replaces "Earn ZAPs" with referral system while preserving all design
 */

import React, { useState, useEffect, useRef } from "react";
import { motion, AnimatePresence } from "framer-motion";
import { Wallet, ChevronDown, Send, Zap, Search, CheckCircle2, X, Link2, Users } from "lucide-react";
...
export const ZapWalletV8: React.FC<ZapWalletV8Props> = ({
  balance,
  earned = 0,
  spent = 0,
  onSendZaps,
